...
public class MainActivity extends AppCompatActivity
    ...
    public void refreshView(final WeatherModel weatherModel) {
        ...
        int[] days = { R.id.day_0, R.id.day_1, R.id.day_2, R.id.day_3 };
        int[] imgs = { R.id.img_0, R.id.img_1, R.id.img_2, R.id.img_3 };
        int[] temps = { R.id.temp_0, R.id.temp_1, R.id.temp_2, R.id.temp_3 };
        for (int i = 0; i < 4; i++) {
            // 刷新日期
            ...
            ((TextView)findViewById(imgs[i])).setText(more.getWeather());
            ((TextView)findViewById(temps[i])).setText(more.getNight_c() + " ~ " + more.getDay_c());
        }

        readTextView.setText(weatherModel.getIndexes()[0]);
